...
export async function POST(req) {
  try {
    ...
    const { role, name, email, country, instagram, about } = body;
    ...
    await resend.emails.send({
      ...
      html: `
        ...
        <table style="border-collapse:collapse;width:100%">
          <tr><td style="padding:8px;border:1px solid #eee;font-weight:600;width:160px">Role</td><td style="padding:8px;border:1px solid #eee">${role || '—'}</td></tr>
